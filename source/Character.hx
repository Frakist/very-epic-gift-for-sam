	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'spooky':
				...
				playAnim('danceRight');
			case 'sam':
				tex = Paths.getSparrowAtlas('characters/sam', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'SamUp', 24, false);
				animation.addByPrefix('singDOWN', 'SamDown', 24, false);
				animation.addByPrefix('singLEFT', 'SamLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'SamRight', 24, false);
				animation.addByIndices('idle', 'SamIdle', [0, 2, 6], "", 12, false);

				loadOffsetFile("sam");

				playAnim('idle');
			case 'glitchcrack':
				tex = Paths.getSparrowAtlas('characters/glitchcrack', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'GlitchUp', 24, false);
				animation.addByPrefix('singDOWN', 'GlitchDown', 24, false);
				animation.addByPrefix('singLEFT', 'GlitchLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'GlitchRight', 24, false);
				animation.addByIndices('idle', 'GlitchIdle', [0, 2, 6], "", 12, false);
			

				loadOffsetFile("glitchcrack");

				playAnim('idle');
			case 'madglitch':
				tex = Paths.getSparrowAtlas('characters/madfatass', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'MadGlitchBlobUp', 24, false);
				animation.addByPrefix('singDOWN', 'MadGlitchBlobDown', 24, false);
				animation.addByPrefix('singLEFT', 'MadGlitchBlobLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'MadGlitchBlobRight', 24, false);
				animation.addByIndices('idle', 'MadGlitchBlobIdle', [0, 2, 6], "", 12, false);
				animation.addByPrefix('angry', 'GlitchTransform', 24, false);
	
				loadOffsetFile("madfatass");
	
				playAnim('idle');

			case 'onslaughter':

				tex = Paths.getSparrowAtlas('characters/SamOnslaughtSprites', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'SamOnslaughtUp', 24, false);
				animation.addByPrefix('singDOWN', 'SamOnslaughtDown', 24, false);
				animation.addByPrefix('singLEFT', 'SamOnslaughtLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'SamOnslaughtRight', 24, false);
				animation.addByIndices('idle', 'SamOnslaughtIdle', [0, 2, 6], "", 12, false);
	
				loadOffsetFile("onslaughter");
	
				playAnim('idle');

			case 'bigsam':

				tex = Paths.getSparrowAtlas('characters/demonsam', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'DemonSamUp', 24, false);
				animation.addByPrefix('singDOWN', 'DemonSamDown', 24, false);
				animation.addByPrefix('singLEFT', 'DemonSamLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'DemonSamRight', 24, false);
				animation.addByIndices('idle', 'DemonSamIdle', [0, 2, 6], "", 12, false);
				scale.set(1.8, 1.8);
		
				loadOffsetFile("demonsam");
			...
			case 'bf':
				...
				frames = tex;
				animation.addByPrefix('idle', 'BlobBFIdle', 24, false);
				animation.addByPrefix('singUP', 'BlobBFUp', 24, false);
				animation.addByPrefix('singLEFT', 'BlobBFLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'BlobBFRight', 24, false);
				animation.addByPrefix('singDOWN', 'BlobBFDown', 24, false);
				animation.addByPrefix('singUPmiss', 'BlobBFMissUp', 24, false);
				animation.addByPrefix('singLEFTmiss', 'BlobBFMissLeft', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'BlobBFMissRight', 24, false);
				animation.addByPrefix('singDOWNmiss', 'BlobBFMissDown', 24, false);

				animation.addByPrefix('firstDeath', "BlobBFDied", 24, false);
				animation.addByPrefix('deathLoop', "BlobBFDead", 24, true);
				animation.addByPrefix('deathConfirm', "BlobBFRetries", 24, false);
