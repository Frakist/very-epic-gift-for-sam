...
class MenuWeek extends MusicBeatState
{
	...
	var weekCharacters:Array<String> = ["gf", "sam", "bad"];

	var weekNames:Array<String> = [
		"How to FUNK",
		"happy birthday sam!",
		"ooooh scary ahhhh scary very3e54354erotfudj"
	];
	...
	function updateText()
	{
		...
		{
			case 'gf':
				characterUI.offset.set(30, 0);
				characterUI.scale.set(0.5, 0.5);
			case 'dad':
				characterUI.offset.set(100, 25);
				characterUI.scale.set(0.5, 0.5);
			case 'spooky':
