...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		else // fallback support
		{
			...
			animation.add('sam', [3, 4, 5], 0, false, isPlayer);
			...
			animation.add('glitchcrack', [15, 16, 17], 0, false, isPlayer);
			...
			animation.add('onslaughter', [12, 13, 14], 0, false, isPlayer);
			animation.add('bigsam', [6, 7, 7], 0, false, isPlayer);
